...
import X from '../../src/x'
import { pure, lift2, State } from '../../src/fantasy'
...
const BMIx = lift2<RX.URI, Intent, BMIState, BMIState, BMIState>(
  (s1, s2) => {
    return s1.chain(p1 => {
      return s2.chain(p2 => {
        let bmi = 0
