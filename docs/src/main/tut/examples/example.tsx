...
let ViewEg5 = props => (
    <div>
       ...
       <input type="range" name="height" onInput={props.actions.fromEvent} min="150" max="200" defaultValue={props.height} />
        </label>
        <label>Weight: {props.weight} kg
       <input type="range" name="weight" onInput={props.actions.fromEvent} min="40" max="100" defaultValue={props.weight} />
        </label>
